...
export async function lookupFile(page, fileNumber, courtValue) {
  ...
  // Enter file number — use precise ID from live page
  await page.fill('#FileNumber', fileNumber);
  await delay(300);

  // Click File Number Search button (first form's submit)
  // id="FileSearchSubmit" is the file-number search button
